 ...
 * @author lorenzo
 */
public class VisLoad1 extends javax.swing.JFrame {

    private final Logger log = LoggerFactory.getLogger(VisLoad1.class);
...
//                    gr2.translate(0, -1/ lclHeight);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VisLoad1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
